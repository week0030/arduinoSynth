...
void MIDI_poll()
{
  ...
  if (Midi.RecvData( &rcvd,  bufMidi) == 0 ) {
    ...
    if ((bufMidi[2]==0x24) || (bufMidi[2]==0x25) || (bufMidi[2]==0x26) || (bufMidi[2]==0x27) || (bufMidi[2]==0x28) || (bufMidi[2]==0x29) || (bufMidi[2]==0x2a) || (bufMidi[2]==0x2b)) {
        ...
        if (bufMidi[2]==0x24) count = 0;
        if (bufMidi[2]==0x25) count = 1;
        if (bufMidi[2]==0x26) count = 2;
        if (bufMidi[2]==0x27) count = 3;
        if (bufMidi[2]==0x28) count = 4;
        if (bufMidi[2]==0x29) count = 5;
        if (bufMidi[2]==0x2a) count = 6;
        if (bufMidi[2]==0x2b) count = 7;
    ...
    if ((bufMidi[6]==0x70) || (bufMidi[2]==0x4a) || (bufMidi[2]==0x47) || (bufMidi[2]==0x4c) || (bufMidi[2]==0x4d) || (bufMidi[2]==0x5d) || (bufMidi[2]==0x49) || (bufMidi[2]==0x4b)) {
        ...
        if (bufMidi[6]==0x70) count = 0;
        if (bufMidi[2]==0x4a) count = 1;
        if (bufMidi[2]==0x47) count = 2;
        if (bufMidi[2]==0x4c) count = 3;
        if (bufMidi[2]==0x4d) count = 4;
        if (bufMidi[2]==0x5d) count = 5;
        if (bufMidi[2]==0x49) count = 6;
        if (bufMidi[2]==0x4b) count = 7;
...
//    }
     ...
     if (count == 1)
    {
      ...
      if (bufMidi[3] >= knob1PrevValues[count])
      {
    ...
    if ((bufMidi[6]==0x72) || (bufMidi[2]==0x12) || (bufMidi[2]==0x13) || (bufMidi[2]==0x10) || (bufMidi[2]==0x11) || (bufMidi[2]==0x5b) || (bufMidi[2]==0x4f) || (bufMidi[2]==0x48)) {
        ...
        if (bufMidi[2]==0x72) count = 0;
        if (bufMidi[2]==0x12) count = 1;
        if (bufMidi[2]==0x13) count = 2;
        if (bufMidi[2]==0x10) count = 3;
        if (bufMidi[2]==0x11) count = 4;
        if (bufMidi[2]==0x5b) count = 5;
        if (bufMidi[2]==0x4f) count = 6;
        if (bufMidi[2]==0x48) count = 7;
